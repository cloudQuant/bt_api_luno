...
from bt_api_luno.feeds.live_luno.spot import LunoRequestDataSpot


def test_luno_request_data_builds_basic_auth_header() -> None:
    """test_luno_request_data_builds_basic_auth_header function"""
...
def test_luno_request_data_accepts_public_private_key_aliases() -> None:
    """test_luno_request_data_accepts_public_private_key_aliases function"""
...
def test_luno_request_data_resolves_exchange_url_for_market_metadata() -> None:
    """test_luno_request_data_resolves_exchange_url_for_market_metadata function"""
    feed = LunoRequestData()
...
def test_luno_spot_get_tick_prepares_request_data() -> None:
    """test_luno_spot_get_tick_prepares_request_data function"""
...
def test_luno_spot_kline_normalizer_returns_candles_payload() -> None:
    """test_luno_spot_kline_normalizer_returns_candles_payload function"""
...
def test_luno_request_data_async_callback_pushes_result_to_queue() -> None:
    """test_luno_request_data_async_callback_pushes_result_to_queue function"""
...
def test_luno_disconnect_closes_http_client() -> None:
    """test_luno_disconnect_closes_http_client function"""
    feed = LunoRequestData()
